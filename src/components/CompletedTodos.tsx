...
const CompletedTodos: React.FC<Props> = ({todoList, requestTodos}) =>  {
  ...
  const columns = [
    ...
    { field: 'deadline', headerName: 'Deadline', width: 190,  sortable: true,
    ...
    { field: 'completedDate', headerName: 'Completed On', width: 190,  sortable: true,
      renderCell: (params: any) => <div style={{ marginLeft: 16, whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow:'hidden'}}>{dateTime(params.row.completedDate)}</div>, 
    },
    {
      field: 'delete',
      headerName: 'Delete',
  ...
  return (
    <div className="todo-table-container">
      <div style={{height: '750px', width: '97%'}}>
        <DataGrid
